...
const ProductPreview = ({
  ...
  const WebsitePreviewComponent = () => {
    console.log("Rendering website preview with websitePreview:", websitePreview ? "data available" : "no data");
    console.log("WebsitePreview data length:", websitePreview?.length || 0);
    
    if (websitePreview && websitePreview.startsWith('data:image/')) {
      console.log("Valid data URL detected for website preview");
      return (
    ...
    console.log("No valid website preview available");
    return (
      <div className="mb-4 border rounded-md overflow-hidden">
        <div className="bg-gray-100 p-2 border-b flex justify-between items-center">
          <div className="flex items-center">
