...
const NavHeader = ({
  ...
  return <header className="relative flex items-center justify-between min-h-[80px] px-6 text-[var(--navbar-light-primary)]">
      <h1 className="text-2xl font-semibold">FanFare</h1>
      {setIsOpen && <Button variant="ghost" size="icon" className="text-[var(--navbar-light-primary)] hover:bg-[var(--navbar-dark-secondary)]" onClick={() => setIsOpen(false)}>
          <X className="h-5 w-5" />
        </Button>}
