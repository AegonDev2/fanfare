    ...
    const fetchProfileImage = async () => {
      ...
      try {
        const {
          data,
          error
        } = await supabase.from('influencer_profiles').select('profile_image').eq('id', user.id).single();
        if (error) {
      ...
      <div className="max-w-full mx-auto px-4 py-3 bg-white">
        <div className="flex items-center justify-between">
          ...
          {user && <div className="flex items-center space-x-3">
              ...
              <Button variant="ghost" size="sm" onClick={() => navigate('/wallet')} className="hidden sm:flex items-center space-x-2 hover:bg-funky-purple/10 hover:text-funky-purple transition-all duration-200 hover-scale">
              ...
              <Button variant="ghost" size="sm" onClick={() => navigate(`/profile/${user.id}`)} className="p-1 hover:bg-funky-purple/10 rounded-full transition-all duration-200 hover-scale">
              ...
              <Button variant="ghost" size="icon" onClick={() => navigate('/wallet')} className="sm:hidden hover:bg-funky-purple/10 hover:text-funky-purple transition-all duration-200">
