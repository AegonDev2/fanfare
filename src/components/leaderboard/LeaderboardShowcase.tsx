          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {leaderboard.slice(0, 3).map((fan, index) => {
              ...
              return (
                <Card 
                  key={fan.fan_id} 
                  className={`${display.bgColor} ${display.borderColor} border-2 ${display.shadowColor} shadow-2xl backdrop-blur-md transform hover:scale-105 transition-all duration-500 relative overflow-hidden`}
                >
                  ...
                  <CardContent className="p-8 text-center relative z-10">
                    ...
                    {fan.favorite_influencer_name && (
                      <Badge 
                        variant="secondary" 
                        className="bg-white/50 text-gray-800 border-gray-400 hover:bg-white/70 transition-colors"
                      >
                        💝 {fan.favorite_influencer_name}
                      </Badge>
                    )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {leaderboard.slice(3).map((fan, index) => {
                    ...
                    return (
                      <Card 
                        key={fan.fan_id}
                        className="bg-gradient-to-br from-white/30 to-purple-100/40 border-purple-300 backdrop-blur-sm hover:scale-105 transition-all duration-300"
                      >
                        <CardContent className="p-6 text-center">
                          ...
                          {fan.favorite_influencer_name && (
                            <Badge variant="outline" className="border-purple-400 text-purple-800 text-xs">
                              💝 {fan.favorite_influencer_name}
                            </Badge>
                          )}
                        </CardContent>
