...
const HeroCarousel = () => {
  ...
  return <div className="relative pb-2 pt-2 sm:pb-4 sm:pt-6 mx-0 overflow-hidden">
      ...
      align: "center"
              ...
              <div className="py-0 my-[15px]">
                <div className="relative aspect-[16/9] overflow-hidden rounded-lg shadow-md">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-2 sm:p-4 flex flex-col items-start justify-end z-20">
                    ...
                    {slide.subtitle && <p className="text-white/80 text-xs max-w-lg line-clamp-2">
                        {slide.subtitle}
                      </p>}
                  </div>
                </div>
        ...
        <CarouselPrevious onClick={previousSlide} className="left-1 h-6 w-6 bg-white/20 backdrop-blur-md border-white/10 hover:bg-white/40 text-white" />
        <CarouselNext onClick={nextSlide} className="right-1 h-6 w-6 bg-white/20 backdrop-blur-md border-white/10 hover:bg-white/40 text-white" />
      </Carousel>
    </div>;
};
