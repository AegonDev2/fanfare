...
const HeroCarousel = ({
  ...
  return (
    <div className="relative pb-4 pt-8 mx-1 my-2 overflow-hidden">
      <Carousel 
        opts={{
          loop: true,
          align: "center"
      ...
      >
        ...
        <CarouselPrevious 
          ...
          className="left-2 md:left-8 bg-white/20 backdrop-blur-md border-white/10 hover:bg-white/40 text-white"
        />
        <CarouselNext 
          onClick={nextSlide}
          className="right-2 md:right-8 bg-white/20 backdrop-blur-md border-white/10 hover:bg-white/40 text-white"
        />
      </Carousel>
    </div>
  );
