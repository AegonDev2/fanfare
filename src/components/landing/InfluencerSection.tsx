...
const InfluencerCard = memo(({
  ...
  return <div className="p-3 shadow-md h-full relative group bg-transparent rounded-none py-[2px] mx-0 px-[7px]">
...
const InfluencerSection = ({
  ...
  return <section className="mb-8 relative py-0 my-[13px] px-0">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-4 py-0 my-0 px-[18px]">
        <h2 className="px-0 mx-0 text-left font-bold py-0 my-[3px] text-gray-800 text-xl">Discover Influencers</h2>
        <div ref={searchInputRef} className="relative w-full md:w-auto px-[7px]">
