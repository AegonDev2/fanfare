...
import { Search, Gift, User, Users, ArrowRight } from "lucide-react";
...
const CreatorCarousel = ({ influencers, onProfileClick, isMobile }: {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-50 to-white border border-funky-purple/10">
      ...
      <button
        onClick={prevSlide}
        className="absolute left-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-white/80 backdrop-blur-sm rounded-full shadow-lg flex items-center justify-center text-funky-purple hover:bg-white transition-all duration-200 hover:scale-110"
      >
      ...
      <button
        onClick={nextSlide}
        className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-white/80 backdrop-blur-sm rounded-full shadow-lg flex items-center justify-center text-funky-purple hover:bg-white transition-all duration-200 hover:scale-110"
      >
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative px-1">
          {influencers && influencers.length > 0 ? (
            <CreatorCarousel
              influencers={influencers.slice(0, 12)}
              onProfileClick={handleProfileClick}
              isMobile={isMobile}
            />
          ) : (
            <div className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl shadow-md text-center border border-funky-purple/10">
