      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold font-display bg-gradient-to-r from-funky-purple to-funky-pink bg-clip-text text-transparent">FanFare</span>
            </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 font-body text-sm">© 2025 FanFare. All rights reserved.</p>
