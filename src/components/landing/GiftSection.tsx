...
const GiftCarousel = ({
  ...
  return <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-white via-funky-pink/5 to-funky-purple/5 border border-funky-pink/20 shadow-sm">
