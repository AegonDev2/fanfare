      ...
      <CardContent className="p-1 lg:p-2 relative z-10">
        ...
        <div className="space-y-1">
          ...
          <Button
            onClick={handleGiftClick}
            size="sm"
            className="w-full mt-2 bg-gradient-to-r from-funky-purple to-funky-pink hover:from-funky-pink hover:to-funky-purple text-white border-0 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 text-[10px] lg:text-xs py-1.5"
          >
...
const GiftCarousel = ({ products }: { products: any[] }) => {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-white via-funky-pink/5 to-funky-purple/5 border-2 border-gradient-to-r from-funky-pink/20 to-funky-purple/20 shadow-xl">
      ...
      <button 
        onClick={scrollPrev} 
        className="absolute left-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-white/80 backdrop-blur-sm rounded-full shadow-lg items-center justify-center text-funky-purple hover:bg-white transition-all duration-200 hover:scale-110 hidden lg:flex z-20"
      >
      ...
      <button 
        onClick={scrollNext} 
        className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-white/80 backdrop-blur-sm rounded-full shadow-lg items-center justify-center text-funky-purple hover:bg-white transition-all duration-200 hover:scale-110 hidden lg:flex z-20"
      >
...
const GiftSection = () => {
  ...
  if (loading) {
    return (
      <section className="mb-8 relative py-8 px-4">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            <div className="relative flex-1 md:flex-none">
              <Input
                ...
                className="w-full md:w-64 lg:w-72 rounded-full backdrop-blur-sm border border-funky-purple/20 focus:border-funky-purple/50 pl-10 pr-4 py-2 text-sm shadow-lg bg-white/90"
              />
            ...
            <Button
              ...
              size="sm"
              onClick={handleViewAllClick}
              className="hidden md:flex items-center gap-2 border-funky-purple/30 text-funky-purple hover:bg-funky-purple/10 hover:border-funky-purple/50 rounded-full"
            >
              View All
              <ArrowRight className="h-4 w-4" />
            </Button>
        ...
        <div className="relative">
          {filteredProducts && filteredProducts.length > 0 ? (
            <GiftCarousel products={filteredProducts.slice(0, 16)} />
          ) : (
            <div className="bg-white/50 backdrop-blur-sm p-12 rounded-3xl shadow-lg text-center border border-funky-purple/10">
