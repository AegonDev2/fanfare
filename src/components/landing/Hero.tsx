...
const Hero = () => {
  ...
  const { userRole, isCheckingRole } = useAdmin();
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            {!isCheckingRole && userRole === 'admin' && (
              <Button 
                size="lg"
                variant="outline"
                className="border-funky-purple text-funky-purple hover:bg-funky-purple hover:text-white transform hover:scale-105 transition-all duration-200 text-sm md:text-base px-6 md:px-8"
