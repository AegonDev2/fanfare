...
const Auth = () => {
  ...
  const handleGoogleAuth = async () => {
    // This function is deprecated - using GoogleLoginButton component instead
    console.warn('Direct handleGoogleAuth called - should use GoogleLoginButton component');
  };
  ...
  if (showPasswordUpdate) {
    return (
      <div className="min-h-screen w-screen bg-black relative overflow-hidden flex items-center justify-center">
        ...
        <div className="w-full max-w-md relative z-10 bg-black/40 backdrop-blur-xl rounded-2xl p-6 border border-white/[0.05]">
          <h2 className="text-xl font-semibold text-center text-white mb-6">Update Your Password</h2>
          <UpdatePasswordForm />
        </div>
      </div>
    );
      ...
      <div className="min-h-screen w-screen bg-black relative overflow-hidden flex items-center justify-center">
        ...
        <div className="w-full max-w-md relative z-10 bg-black/40 backdrop-blur-xl rounded-2xl p-6 border border-white/[0.05]">
          ...
          <button 
            ...
            className="w-full mt-4 text-white/60 hover:text-white transition-colors duration-200 text-sm"
          >
            Back to Login
          </button>
        </div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-black/40 backdrop-blur-xl rounded-2xl p-6 border border-white/[0.05] shadow-2xl overflow-hidden">
              ...
              <div className="text-center space-y-1 mb-5">
                ...
                >
                  {isSignUp ? "Join FanFare today" : "Sign in to continue to FanFare"}
                </motion.p>
              </div>
              ...
              {authError && (
                <Alert variant="destructive" className="mb-4 bg-red-500/10 border-red-500/20">
                  ...
                  <AlertDescription className="text-white">{authError}</AlertDescription>
                </Alert>
              )}
