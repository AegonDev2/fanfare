...
const Landing = ({
  ...
  return <div className="min-h-screen w-full">
      <main className="container mx-auto sm:px-6 lg:px-8 max-w-7xl pt-4 pb-24 py-0 my-[2px] px-px">
        <HeroCarousel slides={slides} />
        
        <div className="mt-12 space-y-12">
          {loading ? <div className="text-center py-12 animate-pulse">
            ...
            </div> : <div className="text-center py-12 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-funky-purple/10 shadow-lg">
