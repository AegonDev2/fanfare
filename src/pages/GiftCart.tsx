  ...
  return <div className="min-h-screen bg-gray-100">
      ...
      <div className="container mx-auto px-4 pt-20 py-8">
        <div className="flex items-center gap-3 mb-6">
          <Button variant="ghost" size="sm" onClick={() => navigate('/gift-selection')} className="text-gray-950 py-0 my-[13px]">
            ...
            <Card>
              <CardHeader>
                <div className="flex justify-between items-center">
                  ...
                  {items.length > 0 && <Button variant="ghost" size="sm" onClick={clearCart} className="text-red-500 hover:text-red-700 hover:bg-red-50">
                    ...
                    {items.map(item => {
                      ...
                      return <div key={item.id} className="flex gap-4 p-4 border rounded-lg">
                          ...
                          <div className="flex-1">
                            ...
                            {item.message && <div className="mt-2 text-xs text-gray-500 italic">
            ...
            <Card className="sticky top-24">
              ...
              <CardFooter>
                <div className="w-full space-y-3">
                  <Button className={cn("w-full bg-gradient-to-r from-funky-purple to-funky-pink text-white", (processing || !user) && "opacity-70 cursor-not-allowed")} onClick={handleCheckout} disabled={items.length === 0 || processing || !user}>
                    {processing ? <>
                  ...
                  <Button variant="outline" className="w-full" onClick={() => navigate('/gift-selection')}>
                    Continue Shopping
                  </Button>
                </div>
              </CardFooter>
