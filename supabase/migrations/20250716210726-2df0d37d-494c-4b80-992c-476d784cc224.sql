-- Drop the old function with single parameter
DROP FUNCTION IF EXISTS public.move_order_to_gift_request(uuid);

-- Ensure we only have the new function with delivery_estimate parameter
